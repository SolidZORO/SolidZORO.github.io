...
if (fs.existsSync(DIR_DAYONE_ENTRIES)) {
    ...
    // // [數組] 存放Page頁
    // var all_page = [];
    // for (var i = 0, j = 0; i < all_day_length; i++) {
    //     console.log(all_day[i].title);

    //     // day壓入all_page
    //     all_page.push(all_day[i].title);
    //     // console.log(i + 1);
    ...
    //             fs.mkdirSync(DIR_PAGE);
    //         }
    //         fs.writeFileSync(DIR_PAGE + DIRNAME_PAGE + '_' + (j + 1) + '.html', html_tag);
